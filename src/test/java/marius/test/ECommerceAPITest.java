...
import marius.pojo.LoginRequest;
import marius.pojo.LoginResponse;
import marius.pojo.OrderDetail;
import marius.pojo.Orders;
...
public class ECommerceAPITest {
    ...
    public static <LoginRequest> void main(String[] args) {
        ...
        marius.pojo.LoginRequest loginRequest = new marius.pojo.LoginRequest();

        loginRequest.setUserEmail("mariusadicu@gmail.com");
        loginRequest.setUserPassword("tg&1K%f6EX6d");
        ...
        RequestSpecification reqAddProduct = given()
                ...
                .param("productPrice", "11569")
                .param("productDescription", "Lenova")
                .param("productFor", "men")
                .multiPart("productImage",new File("/Users/marius/Desktop/C.T./Extra Documentation : Mentor Hour/Student Note Sharing/Screen Shot 2022-01-20 at 10.23.04 PM.png"));
        ...
        orderDetail.setCountry("Mauritius");
